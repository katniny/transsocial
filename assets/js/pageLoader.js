    ...
    if (user) {
        ...
        firebase.database().ref(`users/${uid}`).once("value", (snapshot) => {
            ...
            if (getTheme.theme === "Dark" || getTheme.theme === undefined) {
                ...
                document.documentElement.style.setProperty('--text-half-transparent', `rgba(${getTheme.themeColors.text}, 0.5)`);
                document.documentElement.style.setProperty('--text-semi-transparent', `rgba(${getTheme.themeColors.text}, 0.7)`);
                document.documentElement.style.setProperty('--profile-picture-bg', getTheme.themeColors.pfpBg);
                ...
                document.documentElement.style.setProperty('--banner-button-bg', getTheme.themeColors.bannerButtonBg);
                document.documentElement.style.setProperty('--note-seperator', getTheme.themeColors.noteSeperator);
                document.documentElement.style.setProperty('--sidebar-button-border', getTheme.themeColors.sidebarButtonBorder);
                document.documentElement.style.setProperty('--modal-background', `rgba(${getTheme.themeColors.modalBackground}, 0.7)`);
                ...
                document.documentElement.style.setProperty('--content-warning', `rgba(${getTheme.themeColors.contentWarning}, 0.5)`);
                document.documentElement.style.setProperty('--skeleton-start', getTheme.themeColors.skeletonStart);
                document.documentElement.style.setProperty('--skeleton-middle', getTheme.themeColors.skeletonMiddle);
                document.documentElement.style.setProperty('--skeleton-end', getTheme.themeColors.skeletonEnd);
